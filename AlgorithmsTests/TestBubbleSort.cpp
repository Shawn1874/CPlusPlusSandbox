...
TEST(TestBubbleSort2, TestWithDeque) {
  std::deque<int> values = { 10, 5, 4, 7, 0, 2 };
  Algorithms::bubbleSort2(values, [](auto first, auto second) {
    return first > second;
    });

  // run 1 produces 0 10 5 7 4 2
  // run 2 produces 0 2 10 7 5 4
  // run 3 produces 0 2 4 5 7 10
